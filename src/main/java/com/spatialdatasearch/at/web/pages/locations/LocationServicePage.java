...
import com.spatialdatasearch.at.model.SuggestRouteModel;
import com.spatialdatasearch.at.persistence.LocationServiceDAO;
import com.spatialdatasearch.at.persistence.RouteServiceDAO;
import com.spatialdatasearch.at.web.pages.index.BasePage;
import com.spatialdatasearch.at.web.pages.upload.UploadFilePage;
import com.spatialdatasearch.at.web.panels.DirectionPanel;
import com.spatialdatasearch.at.web.panels.RatingsPanel;
...
public class LocationServicePage extends BasePage {
  ...
  public LocationServicePage() throws IOException {
    ...
    AjaxButton clearSearch = new AjaxButton("clearSearch") {
    ...
    AjaxButton btnGetMyGeo = new AjaxButton("btnGetMyGeo") {
        ...
        if (geoCoordInputValue != null) {
          ...
          for (LocationModel loc : origList) {
            ...
            if (!geoCoordInputValue.isEmpty()) {
              // log.info("My coordinates are: " + myLatitude + " , " + myLongitude);
              double dist =
    ...
    PageableListView<LocationModel> listView = new PageableListView<LocationModel>(id, list, num) {
      ...
      public void populateItem(final ListItem<LocationModel> item) {
        ...
        if (obj.getPhone() != null) {
          ...
          item.add(new Label("phone", "tel:" + obj.getPhone()));
        } else {
  ...
  public void saveTour(final WebMarkupContainer datacontainer) {
    ...
    final AjaxButton buttonClear = new AjaxButton("clearRoute") {
