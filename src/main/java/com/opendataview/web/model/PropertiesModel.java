...
public class PropertiesModel implements Serializable {
  ...
  @Column(columnDefinition = "TEXT")
  protected String removeExistingBData;
  @Column(columnDefinition = "TEXT")
  ...
  @Column(columnDefinition = "TEXT")
  protected String processed_dir;
  @Column(columnDefinition = "TEXT")
  protected String newformat_dir;
  @Column(columnDefinition = "TEXT")
  protected String enriched_dir;
  @Column(columnDefinition = "TEXT")
...
public String getRemoveExistingBData() {
	return removeExistingBData;
}
public void setRemoveExistingBData(String removeExistingBData) {
	this.removeExistingBData = removeExistingBData;
}
...
public String getProcessed_dir() {
	return processed_dir;
}
public void setProcessed_dir(String processed_dir) {
...
public String getEnriched_dir() {
	return enriched_dir;
}
public void setEnriched_dir(String enriched_dir) {
	this.enriched_dir = enriched_dir;
}
...
public void setPossiblenameRegex(String possiblenameRegex) {
