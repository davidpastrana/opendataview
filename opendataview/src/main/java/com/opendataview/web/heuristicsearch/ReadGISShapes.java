...
public double[] getNutsLatLng(String nutsCode) throws IOException, CQLException {

    org.opengis.filter.Filter filter = ECQL.toFilter("NUTS_ID = '" + nutsCode + "'");

    ShapefileDataStore dataStore = new ShapefileDataStore(getClass().getResource("/shapes/NUTS_RG_01M_2013.shp"));
